...
function FormInput() {
    return (
        ...
        <input id="chooseWasm" className="chooseWasm__input" type="file" accept=".wasm"></input>
        <label className="chooseWasm__label" htmlFor="chooseWasm">
            <svg className="chooseWasm__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <span className="chooseWasm__text">Drag and drop  or attach .wasm file</span>
        </label>
        </div>
        </form>
    )
